...
('C015', 'São Gonçalo'),
('C016', 'Maceió'),
('C017', 'Duque de Caxias'),
('C018', 'Natal'),
('C019', 'Teresina'),
('C020', 'São Bernardo do Campo'),
('C021', 'Nova Iguaçu'),
('C022', 'Campo Grande'),
('C023', 'João Pessoa'),
('C024', 'Santo André'),
('C025', 'Osasco'),
('C026', 'São José dos Campos'),
('C027', 'Jaboatão dos Guararapes'),
('C028', 'Ribeirão Preto'),
('C029', 'Uberlândia'),
('C030', 'Contagem'),
('C031', 'Sorocaba'),
('C032', 'Aracaju'),
('C033', 'Feira de Santana'),
('C034', 'Cuiabá'),
('C035', 'Joinville'),
('C036', 'Juiz de Fora'),
('C037', 'Londrina'),
('C038', 'Aparecida de Goiânia'),
('C039', 'Ananindeua'),
('C040', 'Niterói'),
('C041', 'Porto Velho'),
('C042', 'Campos dos Goytacazes'),
('C043', 'Belford Roxo'),
('C044', 'Serra'),
('C045', 'Caxias do Sul'),
('C046', 'Vila Velha'),
('C047', 'Florianópolis'),
('C048', 'São João de Meriti'),
('C049', 'Mauá'),
('C050', 'Macapá'),
('C051', 'São José do Rio Preto'),
('C052', 'Santos'),
('C053', 'Mogi das Cruzes'),
('C054', 'Betim'),
('C055', 'Diadema'),
('C056', 'Campina Grande'),
('C057', 'Jundiaí'),
...
('C067', 'Vitória'),
('C068', 'Caucaia'),
('C069', 'Itaquaquecetuba'),
('C070', 'Caruaru'),
('C071', 'Pelotas'),
('C072', 'Vitória da Conquista'),
('C073', 'Canoas'),
('C074', 'Franca'),
('C075', 'Ponta Grossa'),
('C076', 'Blumenau'),
...
('C086', 'Limeira'),
('C087', 'Praia Grande'),
('C088', 'São José dos Pinhais'),
('C089', 'Santarém'),
('C090', 'Mossoró'),
('C091', 'Suzano'),
('C092', 'Palmas'),
('C093', 'Camaçari'),
('C094', 'Governador Valadares'),
('C095', 'Santa Maria'),
('C096', 'Gravataí'),
('C097', 'Taboão da Serra'),
('C098', 'Várzea Grande'),
('C099', 'Sumaré'),
('C100', 'Marabá');
