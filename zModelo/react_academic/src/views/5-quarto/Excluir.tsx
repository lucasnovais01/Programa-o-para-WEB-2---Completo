...
// ============================================================
// COMPONENTE: Excluir Quarto
// ============================================================
// Propósito: Exibir dados do quarto e confirmar exclusão
...
export default function ExcluirQuarto() {
  ...
  const onDelete = async () => {
    ...
    if (
      !confirm(
        `⚠️ ATENÇÃO! Tem certeza que deseja EXCLUIR o quarto ID: ${idQuarto}? Esta ação é irreversível!`
      )
    ) {
      return;
    }
    ...
    try {
      const id = Number(idQuarto);
      console.log("[Excluir.tsx] Tentando excluir quarto ID:", id);
      const response = await apiDeleteQuarto(id);
      ...
      alert(QUARTO.OPERACAO.EXCLUIR.ERRO);
    }
  };
      ...
      <section className="devtools-banner">
        <div className="container text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {QUARTO.TITULO.EXCLUIR}
          </h1>
          <p className="text-xl">Confirme a exclusão do quarto</p>
        </div>
      </section>
        ...
        >
          ...
          <div className="form-actions">
            <button
              ...
              onClick={onDelete}
              disabled={deleting}
              title={QUARTO.OPERACAO.EXCLUIR.ACAO}
            >
