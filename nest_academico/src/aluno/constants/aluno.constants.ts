...
export const ALUNO = {
  ...
  SWAGGER: {
    ...
    COD_ALUNO: `Código do ${ENTITY_NAME} cadastrado`,
    NOME_ALUNO: `Nome de ${ENTITY_NAME} cadastrado`,
    IDADE: `Idade do ${ENTITY_NAME} cadastrado`,
  },
  ...
  INPUT_ERROR: {
    ...
    COD_ALUNO: {
      BLANK: `Código de ${ENTITY_NAME} deve ser informado`,
      VALID: `Código de ${ENTITY_NAME} deve sr informado`,
